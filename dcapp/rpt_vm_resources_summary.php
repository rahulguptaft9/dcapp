 ...
 */
    ...
    class rpt_vm_resources_summaryPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('VM Resources Summary');
            $this->SetMenuLabel('VM Resources Summary');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`rpt_vm_resources_summary`');
            $this->dataset->addFields(
                array(
                    new StringField('Used_For', false, true),
                    new IntegerField('Qty', true, true),
                    new IntegerField('vCPU', false, true),
                    new IntegerField('RAM(GB)', false, true),
                    new IntegerField('HDD(GB)', false, true)
                )
            );
        }
        ...
        {
            $chart = new Chart('VM01', Chart::TYPE_BAR, $this->dataset);
            $chart->setTitle('VM Resource Utilization');
            $chart->setDomainColumn('Used_For', 'Used_For', 'string');
            $chart->addDataColumn('Qty', '', 'int')
    ...
    try
    {
        $Page = new rpt_vm_resources_summaryPage("rpt_vm_resources_summary", "rpt_vm_resources_summary.php", GetCurrentUserPermissionsForPage("rpt_vm_resources_summary"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("rpt_vm_resources_summary"));
