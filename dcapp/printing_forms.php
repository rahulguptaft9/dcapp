 ...
 */
    ...
    class printing_formsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Printing Forms');
            $this->SetMenuLabel('Printing Forms');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new UploadFileToFolderColumn('Document', 'Document', $editor, $this->dataset, false, false, '../Upload/PrintingForms', '%file_size%_%original_file_name%', $this->OnFileUpload, false);
    ...
    try
    {
        $Page = new printing_formsPage("printing_forms", "printing_forms.php", GetCurrentUserPermissionsForPage("printing_forms"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("printing_forms"));
