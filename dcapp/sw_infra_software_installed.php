 ...
 */
    ...
    class sw_infra_software_installed_sw_service_detailsPage extends DetailPage
    {
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'Service_ON', 'Service_ON', 'Service ON'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_sw_infra_software_installed_sw_service_details_Service_name_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Service_name', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_infra_software_installed_sw_service_details_Service_name_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_infra_software_installed_sw_service_details_Type_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Type', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_infra_software_installed_sw_service_details_Type_search');
            ...
            $main_editor = new ComboBox('service_on_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $main_editor->SetAllowNullValue(false);
            
            $multi_value_select_editor = new MultiValueSelect('Service_ON');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_infra_software_installed_sw_service_details_Project_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Project', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_infra_software_installed_sw_service_details_Project_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_infra_software_installed_sw_service_details_Size_IN_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Size_IN', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_infra_software_installed_sw_service_details_Size_IN_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_infra_software_installed_sw_service_details_BW_IN_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('BW_IN', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_infra_software_installed_sw_service_details_BW_IN_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_infra_software_installed_sw_service_details_Service_ID_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Service_ID', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_infra_software_installed_sw_service_details_Service_ID_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for Service_ON field
            //
            $column = new TextViewColumn('Service_ON', 'Service_ON', 'Service ON', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new CustomEditColumn('Service ON', 'Service_ON', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Service ID', 'Service_ID', 'Service_ID_Service_ID', 'edit_sw_infra_software_installed_sw_service_details_Service_ID_search', $editor, $this->dataset, $lookupDataset, 'id', 'Service_ID', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Service_ID', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Service ID', 'Service_ID', 'Service_ID_Service_ID', 'multi_edit_sw_infra_software_installed_sw_service_details_Service_ID_search', $editor, $this->dataset, $lookupDataset, 'id', 'Service_ID', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        }
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Service_ID', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Service ID', 'Service_ID', 'Service_ID_Service_ID', 'insert_sw_infra_software_installed_sw_service_details_Service_ID_search', $editor, $this->dataset, $lookupDataset, 'id', 'Service_ID', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Service_ID', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_sw_infra_software_installed_sw_service_details_Service_ID_search', 'id', 'Service_ID', null, 20);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_infra_software_installed_sw_service_details_Service_name_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_infra_software_installed_sw_service_details_Type_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_infra_software_installed_sw_service_details_Project_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_infra_software_installed_sw_service_details_Size_IN_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_infra_software_installed_sw_service_details_BW_IN_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Service_ID', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_infra_software_installed_sw_service_details_Service_ID_search', 'id', 'Service_ID', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Service_ID', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_sw_infra_software_installed_sw_service_details_Service_ID_search', 'id', 'Service_ID', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Service_ID', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_sw_infra_software_installed_sw_service_details_Service_ID_search', 'id', 'Service_ID', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class sw_infra_software_installedPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle(' - Infra Software Installed');
            $this->SetMenuLabel(' - Infra Software Installed');
    
            $this->dataset = new TableDataset(
                MySqlIConnectionFactory::getInstance(),
                GetConnectionOptions(),
                '`sw_infra_software_installed`');
            $this->dataset->addFields(
                array(
                    new IntegerField('id', true, true, true),
            ...
            $this->dataset->AddLookupField('Software', 'vw_software_company', new IntegerField('id'), new StringField('Soft', false, false, false, false, 'Software_Soft', 'Software_Soft_vw_software_company'), 'Software_Soft_vw_software_company');
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'Software', 'Software_Soft', 'Software')
            );
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_infra_software_installed_CDAC_ID_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('CDAC_ID', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_infra_software_installed_CDAC_ID_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_infra_software_installed_Software_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Software', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_infra_software_installed_Software_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('sw_infra_software_installed.sw_service_details')->HasViewGrant() && $withDetails)
            {
            //
            // View column for sw_infra_software_installed_sw_service_details detail
            //
            $column = new DetailColumn(array('id'), 'sw_infra_software_installed.sw_service_details', 'sw_infra_software_installed_sw_service_details_handler', $this->dataset, 'Sw Service Details');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            ...
            //
            // View column for Soft field
            //
            $column = new TextViewColumn('Software', 'Software_Soft', 'Software', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('CDAC ID', 'CDAC_ID', 'CDAC_ID_CDAC_ID', 'edit_sw_infra_software_installed_CDAC_ID_search', $editor, $this->dataset, $lookupDataset, 'id', 'CDAC_ID', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $lookupDataset->addFields(
                array(
                    new IntegerField('id', true),
                    new StringField('Soft'),
                    new IntegerField('Type', true)
                )
            );
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'Type = 2 or Type = 4'));
            $editColumn = new DynamicLookupEditColumn('Software', 'Software', 'Software_Soft', 'edit_sw_infra_software_installed_Software_search', $editor, $this->dataset, $lookupDataset, 'id', 'Soft', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('CDAC_ID', 'ASC');
            $editColumn = new DynamicLookupEditColumn('CDAC ID', 'CDAC_ID', 'CDAC_ID_CDAC_ID', 'multi_edit_sw_infra_software_installed_CDAC_ID_search', $editor, $this->dataset, $lookupDataset, 'id', 'CDAC_ID', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'Type = 2 or Type = 4'));
            $editColumn = new DynamicLookupEditColumn('Software', 'Software', 'Software_Soft', 'multi_edit_sw_infra_software_installed_Software_search', $editor, $this->dataset, $lookupDataset, 'id', 'Soft', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        }
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('CDAC_ID', 'ASC');
            $editColumn = new DynamicLookupEditColumn('CDAC ID', 'CDAC_ID', 'CDAC_ID_CDAC_ID', 'insert_sw_infra_software_installed_CDAC_ID_search', $editor, $this->dataset, $lookupDataset, 'id', 'CDAC_ID', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'Type = 2 or Type = 4'));
            $editColumn = new DynamicLookupEditColumn('Software', 'Software', 'Software_Soft', 'insert_sw_infra_software_installed_Software_search', $editor, $this->dataset, $lookupDataset, 'id', 'Soft', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            $grid->SetShowAddButton(true && $this->GetSecurityInfo()->HasAddGrant());
        ...
        protected function doRegisterHandlers() {
            $detailPage = new sw_infra_software_installed_sw_service_detailsPage('sw_infra_software_installed_sw_service_details', $this, array('Service_ON'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('sw_infra_software_installed.sw_service_details'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('sw_infra_software_installed.sw_service_details'));
            $detailPage->SetHttpHandlerName('sw_infra_software_installed_sw_service_details_handler');
            $handler = new PageHTTPHandler('sw_infra_software_installed_sw_service_details_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('CDAC_ID', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_sw_infra_software_installed_CDAC_ID_search', 'id', 'CDAC_ID', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'Type = 2 or Type = 4'));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_sw_infra_software_installed_Software_search', 'id', 'Soft', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('CDAC_ID', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_infra_software_installed_CDAC_ID_search', 'id', 'CDAC_ID', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'Type = 2 or Type = 4'));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_infra_software_installed_Software_search', 'id', 'Soft', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('CDAC_ID', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_sw_infra_software_installed_CDAC_ID_search', 'id', 'CDAC_ID', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'Type = 2 or Type = 4'));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_sw_infra_software_installed_Software_search', 'id', 'Soft', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('CDAC_ID', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_sw_infra_software_installed_CDAC_ID_search', 'id', 'CDAC_ID', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'Type = 2 or Type = 4'));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_sw_infra_software_installed_Software_search', 'id', 'Soft', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new sw_infra_software_installedPage("sw_infra_software_installed", "sw_infra_software_installed.php", GetCurrentUserPermissionsForPage("sw_infra_software_installed"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("sw_infra_software_installed"));
