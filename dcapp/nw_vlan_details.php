 ...
 */
    ...
    class nw_vlan_details_nw_firewall_detailsPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddLookupField('Source', 'nw_ip_subnet', new IntegerField('id'), new StringField('IPv4', false, false, false, false, 'Source_IPv4', 'Source_IPv4_nw_ip_subnet'), 'Source_IPv4_nw_ip_subnet');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'Source', 'Source_IPv4', 'Source'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_nw_vlan_details_nw_firewall_details_Context_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Context', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_nw_vlan_details_nw_firewall_details_Context_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_nw_vlan_details_nw_firewall_details_Source_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Source', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_nw_vlan_details_nw_firewall_details_Source_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_nw_vlan_details_nw_firewall_details_Action_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Action', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_nw_vlan_details_nw_firewall_details_Action_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_nw_vlan_details_nw_firewall_details_Applied_on_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Applied_on', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_nw_vlan_details_nw_firewall_details_Applied_on_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_nw_vlan_details_nw_firewall_details_ACL_Name_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('ACL_Name', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_nw_vlan_details_nw_firewall_details_ACL_Name_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('Source', 'Source_IPv4', 'Source', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('IPv4', 'ASC');
            $editColumn = new LookUpEditColumn(
                'Source', 
                'Source', 
                $editor, 
                $this->dataset, 'id', 'IPv4', $lookupDataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_nw_vlan_details_nw_firewall_details_Context_search', 'id', 'Name', null, 20);
            ...
            $lookupDataset->setOrderByField('IPv4', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_nw_vlan_details_nw_firewall_details_Source_search', 'id', 'IPv4', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_nw_vlan_details_nw_firewall_details_Action_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('vlan_id', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_nw_vlan_details_nw_firewall_details_Applied_on_search', 'id', 'vlan_id', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_nw_vlan_details_nw_firewall_details_ACL_Name_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class nw_vlan_detailsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle(' - Vlan Details');
            $this->SetMenuLabel(' - Vlan Details');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_nw_vlan_details_Type_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Type', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_nw_vlan_details_Type_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_nw_vlan_details_IP_Subnet_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('IP_Subnet', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_nw_vlan_details_IP_Subnet_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('nw_vlan_details.nw_firewall_details')->HasViewGrant() && $withDetails)
            {
            //
            // View column for nw_vlan_details_nw_firewall_details detail
            //
            $column = new DetailColumn(array('id'), 'nw_vlan_details.nw_firewall_details', 'nw_vlan_details_nw_firewall_details_handler', $this->dataset, 'Nw Firewall Details');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('IP Subnet', 'IP_Subnet', 'IP_Subnet_IP', 'edit_nw_vlan_details_IP_Subnet_search', $editor, $this->dataset, $lookupDataset, 'id', 'IP', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('IP', 'ASC');
            $editColumn = new DynamicLookupEditColumn('IP Subnet', 'IP_Subnet', 'IP_Subnet_IP', 'multi_edit_nw_vlan_details_IP_Subnet_search', $editor, $this->dataset, $lookupDataset, 'id', 'IP', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('IP', 'ASC');
            $editColumn = new DynamicLookupEditColumn('IP Subnet', 'IP_Subnet', 'IP_Subnet_IP', 'insert_nw_vlan_details_IP_Subnet_search', $editor, $this->dataset, $lookupDataset, 'id', 'IP', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new nw_vlan_details_nw_firewall_detailsPage('nw_vlan_details_nw_firewall_details', $this, array('Applied_on'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('nw_vlan_details.nw_firewall_details'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('nw_vlan_details.nw_firewall_details'));
            $detailPage->SetHttpHandlerName('nw_vlan_details_nw_firewall_details_handler');
            $handler = new PageHTTPHandler('nw_vlan_details_nw_firewall_details_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('IP', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_nw_vlan_details_IP_Subnet_search', 'id', 'IP', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_nw_vlan_details_Type_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('IP', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_nw_vlan_details_IP_Subnet_search', 'id', 'IP', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('IP', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_nw_vlan_details_IP_Subnet_search', 'id', 'IP', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('IP', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_nw_vlan_details_IP_Subnet_search', 'id', 'IP', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new nw_vlan_detailsPage("nw_vlan_details", "nw_vlan_details.php", GetCurrentUserPermissionsForPage("nw_vlan_details"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("nw_vlan_details"));
