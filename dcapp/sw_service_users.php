 ...
 */
    ...
    class sw_service_usersPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle(' - Service Users');
            $this->SetMenuLabel(' - Service Users');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_sw_service_users_Software_Service_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Software_Service', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_service_users_Software_Service_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new DynamicCombobox('software_service_edit', $this->CreateLinkBuilder());
            ...
            $editColumn = new DynamicLookupEditColumn('Software Service', 'Software_Service', 'Software_Service_Service', 'edit_sw_service_users_Software_Service_search', $editor, $this->dataset, $lookupDataset, 'id', 'Service', '');
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Service', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Software Service', 'Software_Service', 'Software_Service_Service', 'multi_edit_sw_service_users_Software_Service_search', $editor, $this->dataset, $lookupDataset, 'id', 'Service', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Service', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Software Service', 'Software_Service', 'Software_Service_Service', 'insert_sw_service_users_Software_Service_search', $editor, $this->dataset, $lookupDataset, 'id', 'Service', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Service', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_sw_service_users_Software_Service_search', 'id', 'Service', null, 2000);
            ...
            $lookupDataset->setOrderByField('Service', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_service_users_Software_Service_search', 'id', 'Service', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Service', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_sw_service_users_Software_Service_search', 'id', 'Service', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Service', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_sw_service_users_Software_Service_search', 'id', 'Service', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new sw_service_usersPage("sw_service_users", "sw_service_users.php", GetCurrentUserPermissionsForPage("sw_service_users"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("sw_service_users"));
