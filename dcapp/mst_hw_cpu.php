 ...
 */
    ...
    class mst_hw_cpu_hw_detailsPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Asset_Owner_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Asset_Owner', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Asset_Owner_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Purchased_Under_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Purchased_Under', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Purchased_Under_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_PO_Number_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('PO_Number', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_PO_Number_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Item_Type_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Item_Type', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Item_Type_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Make_Model_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Make_Model', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Make_Model_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Processor_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Processor', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Processor_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_RAID_Controller_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('RAID_Controller', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_RAID_Controller_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Power_Supply_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Power_Supply', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Power_Supply_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Status_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Status', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_mst_hw_cpu_hw_details_Status_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Asset Owner', 'Asset_Owner', 'Asset_Owner_Name', 'edit_mst_hw_cpu_hw_details_Asset_Owner_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Purchased Under', 'Purchased_Under', 'Purchased_Under_Name', 'edit_mst_hw_cpu_hw_details_Purchased_Under_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            ...
            $editColumn = new DynamicLookupEditColumn('PO Number', 'PO_Number', 'PO_Number_number', 'edit_mst_hw_cpu_hw_details_PO_Number_search', $editor, $this->dataset, $lookupDataset, 'id', 'number', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Item Type', 'Item_Type', 'Item_Type_Type', 'edit_mst_hw_cpu_hw_details_Item_Type_search', $editor, $this->dataset, $lookupDataset, 'id', 'Type', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Make Model', 'Make_Model', 'Make_Model_Make_Model', 'edit_mst_hw_cpu_hw_details_Make_Model_search', $editor, $this->dataset, $lookupDataset, 'id', 'Make_Model', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Processor', 'Processor', 'Processor_Cores', 'edit_mst_hw_cpu_hw_details_Processor_search', $editor, $this->dataset, $lookupDataset, 'id', 'Cores', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $editColumn = new DynamicLookupEditColumn('RAID Controller', 'RAID_Controller', 'RAID_Controller_Type', 'edit_mst_hw_cpu_hw_details_RAID_Controller_search', $editor, $this->dataset, $lookupDataset, 'id', 'Type', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Power Supply', 'Power_Supply', 'Power_Supply_Type', 'edit_mst_hw_cpu_hw_details_Power_Supply_search', $editor, $this->dataset, $lookupDataset, 'id', 'Type', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Status', 'Status', 'Status_Status', 'edit_mst_hw_cpu_hw_details_Status_search', $editor, $this->dataset, $lookupDataset, 'id', 'Status', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Asset Owner', 'Asset_Owner', 'Asset_Owner_Name', 'multi_edit_mst_hw_cpu_hw_details_Asset_Owner_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Purchased Under', 'Purchased_Under', 'Purchased_Under_Name', 'multi_edit_mst_hw_cpu_hw_details_Purchased_Under_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('number', 'ASC');
            $editColumn = new DynamicLookupEditColumn('PO Number', 'PO_Number', 'PO_Number_number', 'multi_edit_mst_hw_cpu_hw_details_PO_Number_search', $editor, $this->dataset, $lookupDataset, 'id', 'number', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Item Type', 'Item_Type', 'Item_Type_Type', 'multi_edit_mst_hw_cpu_hw_details_Item_Type_search', $editor, $this->dataset, $lookupDataset, 'id', 'Type', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Make_Model', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Make Model', 'Make_Model', 'Make_Model_Make_Model', 'multi_edit_mst_hw_cpu_hw_details_Make_Model_search', $editor, $this->dataset, $lookupDataset, 'id', 'Make_Model', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Cores', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Processor', 'Processor', 'Processor_Cores', 'multi_edit_mst_hw_cpu_hw_details_Processor_search', $editor, $this->dataset, $lookupDataset, 'id', 'Cores', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $editColumn = new DynamicLookupEditColumn('RAID Controller', 'RAID_Controller', 'RAID_Controller_Type', 'multi_edit_mst_hw_cpu_hw_details_RAID_Controller_search', $editor, $this->dataset, $lookupDataset, 'id', 'Type', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Power Supply', 'Power_Supply', 'Power_Supply_Type', 'multi_edit_mst_hw_cpu_hw_details_Power_Supply_search', $editor, $this->dataset, $lookupDataset, 'id', 'Type', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Status', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Status', 'Status', 'Status_Status', 'multi_edit_mst_hw_cpu_hw_details_Status_search', $editor, $this->dataset, $lookupDataset, 'id', 'Status', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Asset Owner', 'Asset_Owner', 'Asset_Owner_Name', 'insert_mst_hw_cpu_hw_details_Asset_Owner_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Purchased Under', 'Purchased_Under', 'Purchased_Under_Name', 'insert_mst_hw_cpu_hw_details_Purchased_Under_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('number', 'ASC');
            $editColumn = new DynamicLookupEditColumn('PO Number', 'PO_Number', 'PO_Number_number', 'insert_mst_hw_cpu_hw_details_PO_Number_search', $editor, $this->dataset, $lookupDataset, 'id', 'number', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Item Type', 'Item_Type', 'Item_Type_Type', 'insert_mst_hw_cpu_hw_details_Item_Type_search', $editor, $this->dataset, $lookupDataset, 'id', 'Type', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Make_Model', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Make Model', 'Make_Model', 'Make_Model_Make_Model', 'insert_mst_hw_cpu_hw_details_Make_Model_search', $editor, $this->dataset, $lookupDataset, 'id', 'Make_Model', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Cores', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Processor', 'Processor', 'Processor_Cores', 'insert_mst_hw_cpu_hw_details_Processor_search', $editor, $this->dataset, $lookupDataset, 'id', 'Cores', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $editColumn = new DynamicLookupEditColumn('RAID Controller', 'RAID_Controller', 'RAID_Controller_Type', 'insert_mst_hw_cpu_hw_details_RAID_Controller_search', $editor, $this->dataset, $lookupDataset, 'id', 'Type', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Power Supply', 'Power_Supply', 'Power_Supply_Type', 'insert_mst_hw_cpu_hw_details_Power_Supply_search', $editor, $this->dataset, $lookupDataset, 'id', 'Type', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Status', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Status', 'Status', 'Status_Status', 'insert_mst_hw_cpu_hw_details_Status_search', $editor, $this->dataset, $lookupDataset, 'id', 'Status', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_mst_hw_cpu_hw_details_Asset_Owner_search', 'id', 'Name', null, 20);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_mst_hw_cpu_hw_details_Purchased_Under_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('number', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_mst_hw_cpu_hw_details_PO_Number_search', 'id', 'number', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_mst_hw_cpu_hw_details_Item_Type_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Make_Model', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_mst_hw_cpu_hw_details_Make_Model_search', 'id', 'Make_Model', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Cores', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_mst_hw_cpu_hw_details_Processor_search', 'id', 'Cores', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_mst_hw_cpu_hw_details_RAID_Controller_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_mst_hw_cpu_hw_details_Power_Supply_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Status', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_mst_hw_cpu_hw_details_Status_search', 'id', 'Status', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_mst_hw_cpu_hw_details_Asset_Owner_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_mst_hw_cpu_hw_details_Purchased_Under_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('number', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_mst_hw_cpu_hw_details_PO_Number_search', 'id', 'number', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_mst_hw_cpu_hw_details_Item_Type_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Make_Model', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_mst_hw_cpu_hw_details_Make_Model_search', 'id', 'Make_Model', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Cores', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_mst_hw_cpu_hw_details_Processor_search', 'id', 'Cores', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_mst_hw_cpu_hw_details_RAID_Controller_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_mst_hw_cpu_hw_details_Power_Supply_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Status', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_mst_hw_cpu_hw_details_Status_search', 'id', 'Status', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_mst_hw_cpu_hw_details_Asset_Owner_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_mst_hw_cpu_hw_details_Purchased_Under_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('number', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_mst_hw_cpu_hw_details_PO_Number_search', 'id', 'number', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_mst_hw_cpu_hw_details_Item_Type_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Make_Model', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_mst_hw_cpu_hw_details_Make_Model_search', 'id', 'Make_Model', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Cores', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_mst_hw_cpu_hw_details_Processor_search', 'id', 'Cores', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_mst_hw_cpu_hw_details_RAID_Controller_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_mst_hw_cpu_hw_details_Power_Supply_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Status', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_mst_hw_cpu_hw_details_Status_search', 'id', 'Status', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_mst_hw_cpu_hw_details_Asset_Owner_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_mst_hw_cpu_hw_details_Purchased_Under_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('number', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_mst_hw_cpu_hw_details_PO_Number_search', 'id', 'number', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_mst_hw_cpu_hw_details_Item_Type_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Make_Model', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_mst_hw_cpu_hw_details_Make_Model_search', 'id', 'Make_Model', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Cores', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_mst_hw_cpu_hw_details_Processor_search', 'id', 'Cores', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_mst_hw_cpu_hw_details_RAID_Controller_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_mst_hw_cpu_hw_details_Power_Supply_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Status', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_mst_hw_cpu_hw_details_Status_search', 'id', 'Status', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class mst_hw_cpuPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Mst Hw Cpu');
            $this->SetMenuLabel('Mst Hw Cpu');
        ...
        protected function getFiltersColumns()
        {
            return array(
                new FilterColumn($this->dataset, 'id', 'id', 'Id'),
                new FilterColumn($this->dataset, 'Cores', 'Cores', 'Cores'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('cores_edit');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('mst_hw_cpu.hw_details')->HasViewGrant() && $withDetails)
            {
            //
            // View column for mst_hw_cpu_hw_details detail
            //
            $column = new DetailColumn(array('id'), 'mst_hw_cpu.hw_details', 'mst_hw_cpu_hw_details_handler', $this->dataset, 'Hw Details');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            ...
            // View column for Cores field
            //
            $column = new NumberViewColumn('Cores', 'Cores', 'Cores', $this->dataset);
            $column->SetOrderable(true);
            $column->setNumberAfterDecimal(0);
            $column->setThousandsSeparator(',');
            $column->setDecimalSeparator('');
        ...
        {
            //
            // Edit column for Cores field
            //
            $editor = new TextEdit('cores_edit');
            $editColumn = new CustomEditColumn('Cores', 'Cores', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new mst_hw_cpu_hw_detailsPage('mst_hw_cpu_hw_details', $this, array('Processor'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('mst_hw_cpu.hw_details'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('mst_hw_cpu.hw_details'));
            $detailPage->SetHttpHandlerName('mst_hw_cpu_hw_details_handler');
            $handler = new PageHTTPHandler('mst_hw_cpu_hw_details_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new mst_hw_cpuPage("mst_hw_cpu", "mst_hw_cpu.php", GetCurrentUserPermissionsForPage("mst_hw_cpu"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("mst_hw_cpu"));
