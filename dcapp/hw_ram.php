 ...
 */
    ...
    class hw_ramPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddLookupField('RAM_Type', 'vw_hw_ram', new IntegerField('id'), new StringField('RAM', false, false, false, false, 'RAM_Type_RAM', 'RAM_Type_RAM_vw_hw_ram'), 'RAM_Type_RAM_vw_hw_ram');
        }
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'RAM_Type', 'RAM_Type_RAM', 'RAM Type'),
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_hw_ram_CDAC_ID_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('CDAC_ID', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_hw_ram_CDAC_ID_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_hw_ram_RAM_Type_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('RAM_Type', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_hw_ram_RAM_Type_search');
            
            $text_editor = new TextEdit('RAM_Type');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('RAM_Type', 'RAM_Type_RAM', 'RAM Type', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('CDAC ID', 'CDAC_ID', 'CDAC_ID_CDAC_ID', 'edit_hw_ram_CDAC_ID_search', $editor, $this->dataset, $lookupDataset, 'id', 'CDAC_ID', '');
            ...
            $lookupDataset->setOrderByField('RAM', 'ASC');
            $editColumn = new LookUpEditColumn(
                'RAM Type', 
                'RAM_Type', 
                $editor, 
                $this->dataset, 'id', 'RAM', $lookupDataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('CDAC_ID', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'CDAC_ID not like  "%/RC/%"'));
            $editColumn = new DynamicLookupEditColumn('CDAC ID', 'CDAC_ID', 'CDAC_ID_CDAC_ID', 'multi_edit_hw_ram_CDAC_ID_search', $editor, $this->dataset, $lookupDataset, 'id', 'CDAC_ID', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('CDAC_ID', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'CDAC_ID not like  "%/RC/%"'));
            $editColumn = new DynamicLookupEditColumn('CDAC ID', 'CDAC_ID', 'CDAC_ID_CDAC_ID', 'insert_hw_ram_CDAC_ID_search', $editor, $this->dataset, $lookupDataset, 'id', 'CDAC_ID', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('CDAC_ID', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'CDAC_ID not like  "%/RC/%"'));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_hw_ram_CDAC_ID_search', 'id', 'CDAC_ID', null, 2000);
            ...
            $lookupDataset->setOrderByField('CDAC_ID', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'CDAC_ID not like  "%/RC/%"'));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_hw_ram_CDAC_ID_search', 'id', 'CDAC_ID', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('RAM', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_hw_ram_RAM_Type_search', 'id', 'RAM', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('CDAC_ID', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'CDAC_ID not like  "%/RC/%"'));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_hw_ram_CDAC_ID_search', 'id', 'CDAC_ID', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('CDAC_ID', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'CDAC_ID not like  "%/RC/%"'));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_hw_ram_CDAC_ID_search', 'id', 'CDAC_ID', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new hw_ramPage("hw_ram", "hw_ram.php", GetCurrentUserPermissionsForPage("hw_ram"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("hw_ram"));
