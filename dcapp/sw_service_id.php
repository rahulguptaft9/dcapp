 ...
 */
    ...
    class sw_service_id_sw_service_detailsPage extends DetailPage
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_Service_ID_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Service_ID', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_Service_ID_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_Service_name_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Service_name', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_Service_name_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_Type_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Type', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_Type_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_Service_ON_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Service_ON', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_Service_ON_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_Project_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Project', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_Project_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_Size_IN_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Size_IN', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_Size_IN_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_BW_IN_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('BW_IN', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_service_id_sw_service_details_BW_IN_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new TextViewColumn('Service_ON', 'Service_ON_Software', 'Service ON', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'Service_ID', 
                $editor, 
                $this->dataset, 'id', 'Service_ID', $lookupDataset);
            ...
            $editColumn = new LookUpEditColumn(
                ...
                'Service_ON', 
                $editor, 
                $this->dataset, 'id', 'Software', $lookupDataset);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Service_ID', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_service_id_sw_service_details_Service_ID_search', 'id', 'Service_ID', null, 20);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_service_id_sw_service_details_Service_name_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_service_id_sw_service_details_Type_search', 'id', 'Type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Software', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_service_id_sw_service_details_Service_ON_search', 'id', 'Software', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_service_id_sw_service_details_Project_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_service_id_sw_service_details_Size_IN_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_service_id_sw_service_details_BW_IN_search', 'id', 'name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class sw_service_idPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Service Initiation');
            $this->SetMenuLabel('Service Initiation');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'Receipt_Date', 'Receipt_Date', 'Receipt Date'),
                new FilterColumn($this->dataset, 'Requester', 'Requester_Person_Org', 'Requester'),
                new FilterColumn($this->dataset, 'Project', 'Project_Name', 'Project'),
                new FilterColumn($this->dataset, 'Start_Date', 'Start_Date', 'Start Date'),
                new FilterColumn($this->dataset, 'End_Date', 'End_Date', 'End Date'),
                new FilterColumn($this->dataset, 'Doc', 'Doc', 'Doc'),
                new FilterColumn($this->dataset, 'Remarks', 'Remarks', 'Remarks')
            );
        }
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ->addColumn($columns['id'])
                ->addColumn($columns['Service_ID'])
                ->addColumn($columns['Receipt_Date'])
                ->addColumn($columns['Requester'])
                ->addColumn($columns['Project'])
                ->addColumn($columns['Start_Date'])
                ->addColumn($columns['End_Date'])
                ->addColumn($columns['Doc'])
                ->addColumn($columns['Remarks']);
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor = new TextEdit('service_id_edit');
            ...
            $main_editor = new DateTimeEdit('receipt_date_edit', false, 'Y-m-d H:i:s');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_service_id_Requester_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Requester', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_service_id_Requester_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_service_id_Project_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Project', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_service_id_Project_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('sw_service_id.sw_service_details')->HasViewGrant() && $withDetails)
            {
            //
            // View column for sw_service_id_sw_service_details detail
            //
            $column = new DetailColumn(array('id'), 'sw_service_id.sw_service_details', 'sw_service_id_sw_service_details_handler', $this->dataset, 'Sw Service Details');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
            ...
            // View column for Service_ID field
            //
            $column = new TextViewColumn('Service_ID', 'Service_ID', 'Service ID', $this->dataset);
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            ...
            //
            // View column for Receipt_Date field
            //
            $column = new DateTimeViewColumn('Receipt_Date', 'Receipt_Date', 'Receipt Date', $this->dataset);
            $column->SetOrderable(true);
            ...
            //
            // View column for Doc field
            //
            $column = new DownloadExternalDataColumn('Doc', 'Doc', 'Doc', $this->dataset, '');
            $column->SetOrderable(true);
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for Receipt_Date field
            //
            $editor = new DateTimeEdit('receipt_date_edit', false, 'Y-m-d H:i:s');
            $editColumn = new CustomEditColumn('Receipt Date', 'Receipt_Date', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Requester', 'Requester', 'Requester_Person_Org', 'edit_sw_service_id_Requester_search', $editor, $this->dataset, $lookupDataset, 'id', 'Person_Org', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Project', 'Project', 'Project_Name', 'edit_sw_service_id_Project_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            //
            // Edit column for Doc field
            //
            $editor = new ImageUploader('doc_edit');
            $editor->SetShowImage(false);
            $editColumn = new UploadFileToFolderColumn('Doc', 'Doc', $editor, $this->dataset, false, false, '../Upload/ServiceInitiation/', '%file_size%_%original_file_name%', $this->OnFileUpload, false);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Person_Org', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Requester', 'Requester', 'Requester_Person_Org', 'multi_edit_sw_service_id_Requester_search', $editor, $this->dataset, $lookupDataset, 'id', 'Person_Org', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Project', 'Project', 'Project_Name', 'multi_edit_sw_service_id_Project_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Person_Org', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Requester', 'Requester', 'Requester_Person_Org', 'insert_sw_service_id_Requester_search', $editor, $this->dataset, $lookupDataset, 'id', 'Person_Org', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Project', 'Project', 'Project_Name', 'insert_sw_service_id_Project_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new sw_service_id_sw_service_detailsPage('sw_service_id_sw_service_details', $this, array('Service_ID'), array('id'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('sw_service_id.sw_service_details'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('sw_service_id.sw_service_details'));
            $detailPage->SetHttpHandlerName('sw_service_id_sw_service_details_handler');
            $handler = new PageHTTPHandler('sw_service_id_sw_service_details_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Person_Org', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_sw_service_id_Requester_search', 'id', 'Person_Org', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_sw_service_id_Project_search', 'id', 'Name', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Person_Org', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_service_id_Requester_search', 'id', 'Person_Org', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_service_id_Project_search', 'id', 'Name', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Person_Org', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_sw_service_id_Requester_search', 'id', 'Person_Org', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_sw_service_id_Project_search', 'id', 'Name', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Person_Org', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_sw_service_id_Requester_search', 'id', 'Person_Org', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_sw_service_id_Project_search', 'id', 'Name', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new sw_service_idPage("sw_service_id", "sw_service_id.php", GetCurrentUserPermissionsForPage("sw_service_id"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("sw_service_id"));
