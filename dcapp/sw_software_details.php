 ...
 */
    ...
    class sw_software_detailsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Software Details');
            $this->SetMenuLabel('Software Details');
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_sw_software_details_Software_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Software', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_software_details_Software_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_software_details_Asset_Owner_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Asset_Owner', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_software_details_Asset_Owner_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_software_details_Purchased_For_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Purchased_For', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_software_details_Purchased_For_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_software_details_PO_Details_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('PO_Details', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_software_details_PO_Details_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_sw_software_details_Licence_Type_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('Licence_Type', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_sw_software_details_Licence_Type_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Software', 'Software', 'Software_Soft', 'edit_sw_software_details_Software_search', $editor, $this->dataset, $lookupDataset, 'id', 'Soft', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Asset Owner', 'Asset_Owner', 'Asset_Owner_Name', 'edit_sw_software_details_Asset_Owner_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Purchased For', 'Purchased_For', 'Purchased_For_Name', 'edit_sw_software_details_Purchased_For_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('PO Details', 'PO_Details', 'PO_Details_number', 'edit_sw_software_details_PO_Details_search', $editor, $this->dataset, $lookupDataset, 'id', 'number', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new UploadFileToFolderColumn('Document', 'Document', $editor, $this->dataset, false, false, '../Upload/Lic/', '%file_size%_%original_file_name%', $this->OnFileUpload, false);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Software', 'Software', 'Software_Soft', 'multi_edit_sw_software_details_Software_search', $editor, $this->dataset, $lookupDataset, 'id', 'Soft', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'type=1 or type = 3'));
            $editColumn = new DynamicLookupEditColumn('Asset Owner', 'Asset_Owner', 'Asset_Owner_Name', 'multi_edit_sw_software_details_Asset_Owner_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Purchased For', 'Purchased_For', 'Purchased_For_Name', 'multi_edit_sw_software_details_Purchased_For_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('number', 'ASC');
            $editColumn = new DynamicLookupEditColumn('PO Details', 'PO_Details', 'PO_Details_number', 'multi_edit_sw_software_details_PO_Details_search', $editor, $this->dataset, $lookupDataset, 'id', 'number', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Software', 'Software', 'Software_Soft', 'insert_sw_software_details_Software_search', $editor, $this->dataset, $lookupDataset, 'id', 'Soft', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'type=1 or type = 3'));
            $editColumn = new DynamicLookupEditColumn('Asset Owner', 'Asset_Owner', 'Asset_Owner_Name', 'insert_sw_software_details_Asset_Owner_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Purchased For', 'Purchased_For', 'Purchased_For_Name', 'insert_sw_software_details_Purchased_For_search', $editor, $this->dataset, $lookupDataset, 'id', 'Name', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('number', 'ASC');
            $editColumn = new DynamicLookupEditColumn('PO Details', 'PO_Details', 'PO_Details_number', 'insert_sw_software_details_PO_Details_search', $editor, $this->dataset, $lookupDataset, 'id', 'number', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_sw_software_details_Software_search', 'id', 'Soft', null, 2000);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'type=1 or type = 3'));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_sw_software_details_Asset_Owner_search', 'id', 'Name', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_sw_software_details_Purchased_For_search', 'id', 'Name', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('number', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_sw_software_details_PO_Details_search', 'id', 'number', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_software_details_Software_search', 'id', 'Soft', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'type=1 or type = 3'));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_software_details_Asset_Owner_search', 'id', 'Name', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_software_details_Purchased_For_search', 'id', 'Name', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('number', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_software_details_PO_Details_search', 'id', 'number', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_sw_software_details_Licence_Type_search', 'id', 'Name', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_sw_software_details_Software_search', 'id', 'Soft', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'type=1 or type = 3'));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_sw_software_details_Asset_Owner_search', 'id', 'Name', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_sw_software_details_Purchased_For_search', 'id', 'Name', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('number', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_sw_software_details_PO_Details_search', 'id', 'number', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Soft', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_sw_software_details_Software_search', 'id', 'Soft', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $lookupDataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), 'type=1 or type = 3'));
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_sw_software_details_Asset_Owner_search', 'id', 'Name', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Name', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_sw_software_details_Purchased_For_search', 'id', 'Name', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('number', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_sw_software_details_PO_Details_search', 'id', 'number', null, 2000);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new sw_software_detailsPage("sw_software_details", "sw_software_details.php", GetCurrentUserPermissionsForPage("sw_software_details"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("sw_software_details"));
